...
from routers import annotate, compress, convert, crop, diff, export, forms, merge, ocr, pages, redact, report, security, split, toc, watermark
...
app.include_router(toc.router,   prefix="/api")
